...
public:	
	...
	void ServerScoreRequest(ATankCharacter* HitCharacter, ATankCharacter* AttackerCharacter, const FVector_NetQuantize& ProjectileStartLocation, const FVector_NetQuantize& ProjectileHitLocation, float HitTime);
...
protected:
	...
	bool ConfirmHitAtTime(ATankCharacter* HitCharacter, const FVector_NetQuantize& ProjectileStartLocation, const FVector_NetQuantize& ProjectileHitLocation, float HitTime);
	...
	* "OutCapsuleLocation" will be set to the capsule location at "Time" */
	...
	bool TraceAgainstCapsule(ATankCharacter* HitCharacter, const FVector_NetQuantize& ProjectileStartLocation, const FVector_NetQuantize& ProjectileHitLocation, const FVector& CapsuleCenter);
